...
export default function SwiperSlider() {
  ...
  return (
    <div className="relative w-full h-[48vw]">
      <Swiper
        loop={true}
        speed={1000}
        parallax={true}
      ...
      {/* Next Button */}
      <div
        className="absolute z-[5] bottom-[20%] left-[10%] w-[3.5vw] h-[3.5vw] overflow-hidden group rounded-full next-button hover:bg-white cursor-pointer border border-white transition-colors duration-300"
        onClick={handleNext}
      >
      ...
      {/* Prev Button */}
      <div
        className="absolute z-[5] bottom-[20%] left-[5%] w-[3.5vw] h-[3.5vw] overflow-hidden group hover:bg-white transition-all duration-500 rounded-full prev-button cursor-pointer border border-white"
        onClick={handlePrev}
      >
      ...
      <div className="absolute bottom-[5%] z-[5] left-[5%]">
