...
const Team = () => {
    ...
    return (
        <>
            <section className='w-screen h-full bg-[#F2F2E9] pb-[10vw] mobile:overflow-hidden mobile:space-y-[8vw]'>
                <div className='px-[5vw] py-[5vw] mobile:space-y-[5vw]'>
                    <h2 data-title-anim className='text-[5vw] font-display mb-[5vw] mobile:text-[12.5vw]'>{t('team')}</h2>
                    ...
                    <div className='w-full h-full flex flex-wrap justify-start gap-[3vw] gap-y-[3vw] mobile:flex-nowrap mobile:w-fit'>
                        {members.map((item, index) => (
                            <div 
                                className='w-[28vw] h-full flex flex-col gap-[1vw] fadeUp mobile:w-[70vw] cursor-pointer transition-transform hover:scale-[1.02]'
                                key={index} 
                            ...
                            >
                                ...
                                <div className='space-y-[0.5vw] mobile:space-y-[2vw]'>
                                    <p data-para-anim className='text-[2.5vw] leading-[1.2] font-display mobile:text-[8vw]'>{item.name}</p>
                                    <p data-para-anim className='h-[5vw] mobile:text-[4.6vw]'>{item.des}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <div className='p-[5vw] mobile:space-y-[5vw]'>
                    <h2 data-title-anim className='text-[3vw] font-display mb-[5vw] mobile:text-[8.2vw]'>{t('teamSub')}</h2>
                    <div className='mobile:overflow-x-scroll mobile:px-0 mobile:w-screen mobile:h-full '>
                    <div className='w-full h-full flex flex-wrap justify-start gap-[3vw] gap-y-[3vw] mobile:w-fit mobile:flex-nowrap mobile:pb-[5vw]'>
                        {boardMembers.map((item, index) => (
                            ...
                            >
                                ...
                                <div className='space-y-[0.5vw] mobile:space-y-[2vw]'>
                                    <p data-para-anim className='text-[2.5vw] leading-[1.2] font-display mobile:text-[8vw]'>{item.name}</p>
                                    <p data-para-anim className='mobile:text-[4.6vw]'>{item.des}</p>
                                
                                    <ul className='list-disc pt-[1vw] pl-[1.5vw] mobile:pl-[4vw]'>
                                        {item.role.map((list, index) => (
                                            <li data-para-anim className='text-[1.2vw] mobile:text-[4vw]' key={index}>{list}</li>
                                        ))}
                                    </ul>
                                </div>
                            </div>
                ...
                <div className='p-[5vw] mobile:space-y-[12vw]'>
                    <h2 data-title-anim className='text-[3vw] font-display mb-[5vw] mobile:text-[10vw]'>{t('teamSub2')}</h2>
                        ...
                        {shariahMembers.map((item, index) => (
                            ...
                            >
                                ...
                                <div className='space-y-[0.5vw]'>
                                    <p data-para-anim className='text-[2.5vw] leading-[1.2] font-display mobile:text-[8vw]'>{item.name}</p>
                                    <p data-para-anim className='h-[5vw] mobile:text-[4vw] mobile:h-[20vw]'>{item.des}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div 
                        className='text-[2.5vw] space-y-[2vw] fadeUp mobile:space-y-[4vw] mobile:text-[4.6vw] mobile:w-[90%]' 
            ...
            {isModalOpen && selectedMember && (
                <>
                    ...
                    <div data-lenis-prevent 
                        ref={modalRef}
                        className="fixed top-0 right-0 h-screen w-[55vw] bg-[#98AD7E] z-50 shadow-lg overflow-y-auto mobile:w-full  "
                    ...
                    >
                        ...
                        <div 
                            ...
                            className='h-full  p-[3vw] pt-[8vw] mobile:pt-[20vw] mobile:px-[8vw] '
                        >
                           
                            <div className="w-full flex flex-col">
                                <div className="relative w-[20vw] h-[26vw] mobile:w-[50vw] mobile:h-[65vw]">
                                    <Image 
                                ...
                                <div className="mt-[2vw] mobile:mt-[4vw]">
                                    <p className="text-[2.9vw] leading-[1.2] font-display mobile:text-[7vw]">
                                        {selectedMember.name}
                                    </p>
                                    ...
                                    <div className='pl-[2vw] pt-[1vw]'>
                                        <ul className='list-disc'>
                                            {selectedMember.features && selectedMember.features.map((item, index) => (
                                                <li  key={index} className="mobile:text-[4vw] py-[0.5vw]">{item}</li>
                                            ))}
                                        </ul>
                                    </div>
                                </div>
