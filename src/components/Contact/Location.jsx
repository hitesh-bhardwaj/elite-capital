...
const Location = () => {
    ...
    return (
        <>
            <section className="relative min-h-screen bg-[#747977] py-[3vw] overflow-hidden mobile:py-[15vw] mobile:min-h-full mobile:h-full tablet:min-h-full tablet:py-[10vw]">
                <div className="relative z-10 px-[5vw]  flex items-center justify-between h-screen mobile:flex-col-reverse mobile:gap-[10vw] mobile:h-full tablet:h-full">
                    <div className="w-[60%] flex h-full items-center justify-between mobile:w-full tablet:w-1/2">
                        <Image
                    ...
                    <div className="text-white w-[45%] mobile:w-full mobile:space-y-[5vw] tablet:w-1/2">
