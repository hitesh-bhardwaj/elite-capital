            ...
            <section className="relative min-h-screen bg-[#747977] py-[3vw] overflow-hidden">
                <div className="relative z-10 px-[5vw]  flex items-center justify-between h-screen">
                    ...
                    <div className="text-black1 w-[45%]">
                        <h2 data-title-anim className="text-[2.9vw] text-white font-display leading-1.15  mb-[1.5vw]">{t('locationHead')}</h2>
                        ...
                        <div className="mt-[1vw]">
                            <h2 data-title-anim className="text-[2.9vw] text-white font-display leading-1.15  mb-[1.5vw]">{t('contactHead')}</h2>
                            <div className="flex items-center justify-start gap-[1vw] pb-[0.5vw]">
                                ...
                                <p data-para-anim className=" w-[60%] text-white">{t('phone')}</p>
                            </div>
                            <div className="flex items-center justify-start gap-[1vw] py-[0.5vw]">
                                ...
                                <p data-para-anim className=" w-[60%] text-white">{t('mail')}</p>
                            ...
                            <div className="flex items-center justify-start gap-[1vw] py-[0.5vw]">
                                ...
                                <p data-para-anim className=" w-[60%] text-white">{t('mail2')}</p>
