...
const Stats = () => {
  ...
  return (
    <>
    <section className="relative bg-[#F4F4F4] h-[48vw] my-[3vw] overflow-hidden  mobile:pb-[10%] tablet:py-[7%]">
   ...
   <div className="flex pl-[3vw] w-1/2 flex-wrap items-center justify-between  gap-y-[6vw] gap-[4vw]">
            ...
            <p data-para-anim className="content w-[75%] text-center mx-auto  mobile:w-1/2  mobile:text-left">{t('stats1')}</p>
            </div>
         <div className="w-[45%]">
            <div className="flex w-full  items-center justify-center gap-[8px] mobile:flex-col mobile:items-start mobile:gap-0">
            ...
            <p data-para-anim className="content w-[75%] mx-auto  mobile:w-1/2  mobile:text-left">{t('stats2')}</p>
            </div>
            <div className="w-[45%]">
            <div className="flex w-full  items-center justify-center gap-[8px] mobile:flex-col mobile:items-start mobile:gap-0">
            ...
            <p data-para-anim className="content w-[75%] mx-auto text-center  mobile:w-1/2  mobile:text-left">{t('stats3')}</p>
            </div>
            <div className="w-[45%]">
            <div className="flex w-full  items-center justify-center gap-[8px] mobile:flex-col mobile:items-start mobile:gap-0">
