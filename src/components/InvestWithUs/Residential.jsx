    ...
    return (
        <section className="bg-[#747977] overflow-hidden py-[5vw] mobile:py-[10vw]">
            <div className="flex items-center">
                <div className="text-white  pl-[4vw] pr-[3.5vw]">
                    <h3 data-title-anim className="text-[5vw]  font-display mb-[4vw] leading-[1] mobile:text-[12.5vw] mobile:leading-[1.2]">{t('residentialHead')}</h3>
                    <p data-para-anim className="w-[90%] text-[1.88vw] mobile:text-[4.9vw]">{t('residentialPara')}</p>
                    <h2 data-title-anim className="text-[3.5vw] font-display pt-[7vw] pb-[5vw]  mobile:leading-[1.2] mobile:text-[10.2vw]">{t('residentialSub')}</h2>
