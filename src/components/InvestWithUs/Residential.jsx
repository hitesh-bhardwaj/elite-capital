...
const Residential = () => {
    ...
    return (
        <section className="bg-[#FFFFFF] overflow-hidden py-[5vw] mobile:py-[10vw] dark tablet:py-[7vw]">
            <div className="flex items-center">
                <div className="text-black1  pl-[4vw] pr-[3.5vw] mobile:space-y-[5vw]">
                    <h2 data-title-anim className="text-[4.5vw] font-display mb-[4vw] leading-[1.2] mobile:text-[10.8vw] mobile:mb-[7vw]  mobile:leading-[1.2] tablet:text-[7vw]">{t('residentialHead')}</h2>
                    <p data-para-anim className="w-[95%] content mobile:text-[4.9vw]">{t('residentialPara')}</p>
                    <h2 data-title-anim className="text-[4.5vw] font-display tracking-tight mobile:text-[10.8vw]  pt-[7vw] mb-[1.5vw]  mobile:leading-[1.2] tablet:text-[7vw]">{t('residentialSub')}</h2>
                    ...
                    <div className="flex justify-between mobile:block mobile:space-y-[15vw] tablet:flex-col tablet:flex-wrap tablet:gap-y-[8vw]">
                      {features.map((item,index)=>(
                        <div className="flex flex-col gap-[1vw] w-[32%] mobile:w-full tablet:w-[65%]  mobile:gap-[3vw] tablet:gap-[1vw]" key={index}>
                            <div className="group fadeup transition-all duration-500 ease overflow-hidden">
                            <Image src={images[index]} alt="factors" height={228} width={556} className=" group-hover:scale-[1.1] transition-all duration-500 ease"/>
                            </div>
                          <h3 data-para-anim className="heading-2  mb-2 leading-[1.2] mobile:text-[8.2vw] tablet:text-[5.5vw]">{item.title}</h3>
