...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#121212] text-white mobile:py-[10vw] tablet:pb-[7%]">
      <div className="px-[5vw] ">
        <div className="pt-[5vw]  ">
          ...
          <div className="uppercase mt-4 content font-medium flex items-end justify-end gap-[5vw] mobile:flex-col  mobile:items-start mobile:my-[8vw] mobile:gap-[4vw] tablet:justify-start tablet:mt-[5vw] ">
          ...
          <div className="flex justify-start items-end flex-col  pb-[5vw] tablet:items-start tablet:mt-[4vw] ">
            <div className="w-[25vw]  mobile:w-full tablet:w-[50%]">
              <p className="text-lg">
                Subscribe for our Newsletter to Receive Updates and Content.
              </p>
            </div>
            <div className="w-[25vw] pb-[0.5vw] relative flex justify-end items-start border-b-[1.5px] border-white pt-[5vw] mobile:w-full mobile:px-[3vw] tablet:w-full tablet:pt-[3vw] tablet:items-end">
              <input
                type="email"
              ...
              />
              <div className="text-[1.25vw] mobile:text-[4.6vw] mt-[0.7vw] text-[#D8AF00] cursor-pointer flex items-center gap-[0.5vw] tablet:text-[2.2vw]">
