...
const About = () => {
    ...
    return (
        <>
            <section className="relative  overflow-hidden h-[55vw] py-[5vw] pb-[8vw] mobile:h-full mobile:py-[15vw] tablet:min-h-fit tablet:pt-[10vw] dark tablet:h-full tablet:pb-[15vw]" id="about" >
