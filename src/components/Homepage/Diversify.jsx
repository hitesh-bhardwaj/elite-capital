            ...
            <div className="flex items-center mobile:flex-col mobile:gap-[8vw] tablet:flex-col ">
                ...
                <div className="text-black1 w-1/2 pl-[4vw] py-[5vw] mobile:w-full mobile:px-[5vw] mobile:space-y-[8vw] tablet:w-full rtl:pr-[4.5vw] rtl:mobile:pr-[5vw]">
                    ...
                    <div className=" content space-y-[3vw] pr-[4.5vw]   mb-[3vw] rtl:pr-0">
                        ...
                        <p data-para-anim>Elite Capital investors will gain access to a curated and exclusive pipeline of over 45 community-focused developments across Ontario, Canada. The pipeline includes several shovel ready purpose-built development projects, each having undergone an extensive development and permitting process.</p>
                        <p data-para-anim>This exclusive pipeline, combined with our rigorous due-diligence process and hands-on asset management, is geared to deliver strong, risk adjusted returns to our investors.</p>
                    </div>
