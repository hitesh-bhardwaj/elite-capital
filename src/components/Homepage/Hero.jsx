    ...
    return (
        <>
            <section className="relative h-screen tablet:h-[80vh] overflow-hidden">
                ...
                <div className="w-[3vw] h-[3vw] flex justify-center items-center rounded-full bg-white absolute bottom-10 right-20 z-[20] cursor-pointer transition hover:scale-110"     onClick={scrollToNext}>
