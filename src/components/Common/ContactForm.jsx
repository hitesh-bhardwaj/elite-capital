            ...
            >
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormControl>
                      <Input placeholder="Full Name*" {...field} className="mobile:placeholder:text-[4.5vw] tablet:placeholder:text-[2.2vw]" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormControl>
                      <Input placeholder="Email*" {...field} className="mobile:placeholder:text-[4.5vw] tablet:placeholder:text-[2.2vw]" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormControl>
                      <Input placeholder="Phone*" {...field} className="mobile:placeholder:text-[4.5vw] tablet:placeholder:text-[2.2vw]" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormControl>
                      <Input placeholder="Company Name*" {...field} className="mobile:placeholder:text-[4.5vw] tablet:placeholder:text-[2.2vw]" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormControl>
                      <Input placeholder="Designation*" {...field} className="mobile:placeholder:text-[4.5vw] tablet:placeholder:text-[2.2vw]" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormControl>
                      <Textarea placeholder="Message*" {...field} className="mobile:placeholder:text-[4.5vw] tablet:placeholder:text-[2.2vw]" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <div className="mt-[2vw] w-full flex justify-start">
                <Button
                  type="submit"
                  className="font-body block font-medium w-fit h-fit text-[1.2vw] bg-black1 text-white hover:bg-white hover:text-black1 rounded-full px-8 py-[1vw] relative mobile:w-[35vw] mobile:h-[15vw]  tablet:h-[7vw] "
                >
                  {!isLoading ? (
                    <div className="flex gap-[0.5vw] mobile:gap-[1.5vw] tablet:gap-[1vw]">

                    <span className="text-[1.1vw]  mobile:text-[4.5vw] tablet:text-[2.5vw]">
                      Submit
                    </span>
                    <svg className={`w-4 mt-[0.2vw] mobile:mt-[1.5vw] tablet:mt-[1vw] `} viewBox="0 0 21 19" fill="none" xmlns="http://www.w3.org/2000/svg">
